...
#BE CAREFUL metadata_dict is a pandas dataframe and not a dicitonary....

def export_csv(Dataframe, metadata_dict, output_path, base_name):

    if len(Dataframe) == len(metadata_dict):
        ...
        for i, df in enumerate(Dataframe):
            ...
            metadata_row = metadata_dict.iloc[i]
            csv_filename = os.path.join(output_csv_data_path, f"{base_name}_PUND_{i}.csv")
